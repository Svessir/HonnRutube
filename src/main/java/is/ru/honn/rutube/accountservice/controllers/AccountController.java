...
import is.ru.honn.rutube.accountservice.services.AccountService;
import is.ru.honn.rutube.accountservice.services.AccountServiceException;
...
public class AccountController {
    ...
    ResponseEntity<PartialAccountDTO> isAuthenticated(@RequestHeader(name = "Token") String token) {
        ...
        return new ResponseEntity<PartialAccountDTO>(new PartialAccountDTO(),HttpStatus.UNAUTHORIZED);
    }
}